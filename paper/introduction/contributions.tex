...
we present a secure AH-BTR based on functional encryption for general circuits~\cite{TCC:BonSahWat11}.
...
Better yet, the bound holds for a specific (weak) attribute-based encryption%
\WideNarrow{ (ABE)}{}~\cite{EC:SahWat05,CCS:GPSW06} scheme, thus also shedding new insights into the efficiency of ABE.
\end{itemize}
