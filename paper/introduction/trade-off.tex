\subsubsection{\hspace*{-0.45em}\scalebox{0.8}[1]{{\fontfamily{ptm}\bfseries\selectfont YOU CAN (NOT) OPTIMIZE\@.}}}
% The \hspace* works around a weird issue with IACR CiC
% so that "YOU" is properly aligned.
