...
\begin{definition}[garbled circuit~\cite{FOCS:Yao86,JC:LinPin09,CCS:BelHoaRog12}]\label{def:gc}
...
\begin{definition}[garbled circuit security~\cite{FOCS:Yao86,JC:LinPin09,CCS:BelHoaRog12}]\label{def:gc-security}
