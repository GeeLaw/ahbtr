...
we can assume, whenever convenient, that all randomized algorithms use a uniformly random $\lambda$-bit string as its randomness (without losing polynomial security).
