...
\def\MyCite#1{\leavevmode\unskip\rlap{\textup{#1}}\hspace*{6em}\ignorespaces}
}
\begin{itemize}
...
In contrast, obfuscation-minimum PKFE security is falsifiable and there are construc\-tions~\cite{STOC:JaiLinSah21,EC:JaiLinSah22corrected} from well-studied complexity assumptions.
