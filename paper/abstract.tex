...
A lower bound on the trade-off between ciphertext size and decryption time is shown, indicating that the two constructions achieve all possible optimal trade-offs, i.e., they fully demonstrate the Pareto front of efficiency.
...
% \keywords{traitor tracing \and broadcast encryption \and attribute-based encryption \and functional encryption \and obfuscation.}

\keywordspdf{traitor tracing;
...
\textbf{To reviewers} having seen this paper on ePrint:
The submitted version is \textbf{newer}.\\
