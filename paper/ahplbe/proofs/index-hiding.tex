% For submission, IACR, Springer, camera ready, the page breaks
% after the previous subsection and before the current subsection,
% so the figure should go to the top of the page.
% For ePrint, the page ends after H_2 is fully described,
% so the figure should go to the bottom of the page.
\WideNarrow{\begin{figure}[!b]}{\begin{figure}[t]}
