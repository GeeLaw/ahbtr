...
Similar to the \hyperlink{pf:ahbtr-from-ahplbe-completeness}{proof} of Theorem~\ref{thm:ahbtr-from-ahplbe-completeness},
...
Let $\alpha$ be a random element in an execution of~$\Trace$,
\begin{align*}
\alpha=\begin{cases}
