...
\begin{construction}[adapted from {\cite[Theorem~1]{C:Zhandry20}}]\label{con:ahbtr-trade-off}
...
${N_1=\lceil N^\gamma\rceil}$\WideNarrow{,}{ and}
${N_2=\lceil N/N_1\rceil}$.
...
\draws\OLD.\Enc(\{\pk^\ast_j\}_{(j_1'-1)N_2<j\leq j_1'N_2}^\sphantom,\mu_0),&
\textup{if }j_1'<j_1;\\
\gets\OLD.\ct^\ast,&\textup{if }j_1'=j_1;\\
\draws\OLD.\Enc(\{\pk^\ast_j\}_{(j_1'-1)N_2<j\leq j_1'N_2}^\sphantom,\mu_1),&
\textup{if }j_1'>j_1.
\end{cases}
\end{align*}
