...
$matches = Select-String -LiteralPath $CryptoBib -Pattern 'ad[ -]?hoc|de-?central|broad-?cast|revoke|revoking|revocation|trace(able)?|tracing|piracy|pirate|water-?mark|(multi[- ](input|authority)).*?(fe|abe|encryption)';
